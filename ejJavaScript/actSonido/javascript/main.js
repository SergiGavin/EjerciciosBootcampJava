...
let reproduciendo;
let tiempo = 0;
fotoGen1 === null || fotoGen1 === void 0 ? void 0 : fotoGen1.addEventListener("click", () => {
    sonido1.play();
    reproduciendo = 1;
    imagenesOff1();
});
fotoGen2 === null || fotoGen2 === void 0 ? void 0 : fotoGen2.addEventListener("click", () => {
    sonido2.play();
    reproduciendo = 2;
    imagenesOff2();
});
fotoGen3 === null || fotoGen3 === void 0 ? void 0 : fotoGen3.addEventListener("click", () => {
    sonido3.play();
    reproduciendo = 3;
    imagenesOff3();
});
fotoGen4 === null || fotoGen4 === void 0 ? void 0 : fotoGen4.addEventListener("click", () => {
    sonido4.play();
    reproduciendo = 4;
    imagenesOff4();
});
fotoGen5 === null || fotoGen5 === void 0 ? void 0 : fotoGen5.addEventListener("click", () => {
    sonido5.play();
    reproduciendo = 5;
    imagenesOff5();
});
fotoGen6 === null || fotoGen6 === void 0 ? void 0 : fotoGen6.addEventListener("click", () => {
    sonido6.play();
    reproduciendo = 6;
    imagenesOff6();
});
console.log(volumen);
btn_volumenMas === null || btn_volumenMas === void 0 ? void 0 : btn_volumenMas.addEventListener("click", () => {
    console.log(volumen);
...
btn_volumenMenos === null || btn_volumenMenos === void 0 ? void 0 : btn_volumenMenos.addEventListener("click", () => {
    console.log(volumen);
    if (reproduciendo != null) {
        if (volumen <= 0.10) {
...
btn_Reset === null || btn_Reset === void 0 ? void 0 : btn_Reset.addEventListener("click", () => {
    if (reproduciendo != null) {
        if (reproduciendo == 1) {
...
btn_selection === null || btn_selection === void 0 ? void 0 : btn_selection.addEventListener("click", () => {
    location.reload();
});
function imagenesOff1() {
    if (fotoGen2 != null && fotoGen3 != null && fotoGen4 != null && fotoGen5 != null && fotoGen6 != null) {
